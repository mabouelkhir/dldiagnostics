...
class AppointmentDetailsPageState extends State<AppointmentDetailsPage> {
  ...
  late List<MaladieModel> maladies = [];
  MaladieModel? selectedMaladie; // Declare this in your StatefulWidget
  ...
  Future<void> _fetchMaladies() async {
    try {
      List<MaladieModel> fetchedMaladies = await apiService.getMaladies();
      setState(() {
        maladies = fetchedMaladies;
      });
    } catch (e) {
      // Handle error if fetching maladies fails
                ...
                children: [
                  ClipOval(
                    child: Image.memory(
                      ...
                      width: 220, // Ajustez la taille de l'image à l'intérieur du cercle
                      height: 220, // Ajustez la taille de l'image à l'intérieur du cercle
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: DropdownButton<MaladieModel>(
                                hint: Text('Select a maladie'),
                                value: selectedMaladie,
                                onChanged: (MaladieModel? value) {
                                  setState(() {
                                    selectedMaladie = value!;
                                  });
                                },
                                items: maladies.map<DropdownMenuItem<MaladieModel>>((MaladieModel maladie) {
                                  return DropdownMenuItem<MaladieModel>(
                                    value: maladie,
                                    child: Text(maladie.nom ?? ""),
                                  );
                                }).toList(),
                              ),
                            ),
                              ...
                              child: Container(
                                ...
                                child: TextButton(
                                  onPressed: () async {
                                    ...
                                    print("fesf");
                                    print(base64Image);
                                    print(model!.patient!.toJson());


                                    var res=await apiService.getDiagnosticResult(base64Image,selectedMaladie!,model!.patient!);
