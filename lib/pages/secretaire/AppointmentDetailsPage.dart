                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () async {
                                        await apiService.ValidateAppointement(model!);
                                        // After updating the appointment status, call getAppointments
                                        await apiService.getAppointments();
                                        Navigator.of(context).pushReplacement(
                                          MaterialPageRoute(
                                            builder: (_) => SecretaireHomePage(),
                                          ),
                                        );
                                      },
                                      child: Text(
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () async {
                                        await apiService.AcceptAppointement(model!);
                                        // After updating the appointment status, call getAppointments
                                        await apiService.getAppointments();
                                        Navigator.of(context).pushReplacement(
                                          MaterialPageRoute(
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    onPressed: () async {
                                      await apiService.RefuseAppointement(model!);
                                      // After updating the appointment status, call getAppointments
                                      await apiService.getAppointments();
                                      Navigator.of(context).pushReplacement(
                                        MaterialPageRoute(
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    onPressed: () async {
                                      await apiService.AdjournAppointement(model!);
                                      // After updating the appointment status, call getAppointments
                                      await apiService.getAppointments();
                                      Navigator.of(context).pushReplacement(
                                        MaterialPageRoute(
